...
| 全量 pytest | 本机 Windows 收集 **1309** → **1303 passed + 6 skipped**；CI/Linux 收集 **1310**(差额仍是 `POSIX_TERMINATION_SIGNALS` 的 SIGHUP 参数) |
...
新的 UI), 而评分/颜色搜索/智能文件夹需要一套"属性的属性"语义 —— 现在记在这里,
